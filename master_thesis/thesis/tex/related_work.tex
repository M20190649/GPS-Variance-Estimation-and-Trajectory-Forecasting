...
KSC can be seen as spectral clustering formulated as weighted kernel PCA problem \cite{Langone2013}\todo{better source?}.
...
\todo{Beskriv KSC, PCA, kernel PCA och LS-SVM}
