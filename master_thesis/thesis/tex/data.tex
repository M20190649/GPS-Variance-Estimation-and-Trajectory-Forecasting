...
\todo{Visa exempel på self-overlap}
\todo{Visa bild hur det påverkar GP (Från Tiger, borde vara okej?)}
\todo{Förklara lite mer ingående exakt hur det påverkas}
\todo{Förklara lätt hur det kan lösas. Det mer ingående kanske inte ska stå här?}
